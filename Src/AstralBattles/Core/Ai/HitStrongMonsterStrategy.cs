...
// Type: AstralBattles.Core.Ai.HitStrongMonsterStrategy
...
{
  public class HitStrongMonsterStrategy : IStrategy
  {
    public CardSummonInfo Get(IBattlefield bf, List<FieldPair> fields) => (CardSummonInfo) null;
  }
}
