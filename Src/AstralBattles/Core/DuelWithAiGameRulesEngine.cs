...
// Type: AstralBattles.Core.DuelWithAiGameRulesEngine
...
{
  public class DuelWithAiGameRulesEngine : GameRulesEngineBase
  {
    public DuelWithAiGameRulesEngine()
    {
    }

    public DuelWithAiGameRulesEngine(IBattlefield bf)
      : base(bf)
    {
    }
