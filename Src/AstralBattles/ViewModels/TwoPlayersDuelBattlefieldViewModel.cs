...
// Type: AstralBattles.ViewModels.TwoPlayersDuelBattlefieldViewModel
...
namespace AstralBattles.ViewModels
{
  ...
  {
    public TwoPlayersDuelBattlefieldViewModel(bool newGame)
      : base(newGame)
    {
    }

    public TwoPlayersDuelBattlefieldViewModel()
    {
    }
    ...
    {
      Serializer.Delete("CurrentTwoPlayerDuelGame__1_452.xml");
      PageNavigationService.TwoPlayersOptions(true);
    }

    protected override GameRulesEngineBase CreateGameRulesEngine()
    {
      return GameService.CurrentGame = (GameRulesEngineBase) new TwoPlayersDuelRulesEngine((IBattlefield) this);
    }
