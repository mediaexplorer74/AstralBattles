...
namespace AstralBattles.ViewModels
{
  ...
  {
    public CampaignBattlefieldViewModel(bool newGame)
      : base(newGame)
    {
    }

    public CampaignBattlefieldViewModel()
    {
    }
    ...
    {
      return GameService.CurrentGame = (GameRulesEngineBase) new CampaignGameRulesEngine((IBattlefield) this);
    }

    protected override void OnGameOver(Player winner)
    {
      Serializer.Delete("CampaignBattlefieldViewModel__1_452.xml");
    }
  }
}
